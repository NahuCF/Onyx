...
namespace MMO {
	...
	const char* MapInstanceTypeName(MapInstanceType type)
	{
		switch (type)
		{
		case MapInstanceType::OpenWorld:
			return "Open World";
		case MapInstanceType::Dungeon:
			return "Dungeon";
		case MapInstanceType::Raid:
			return "Raid";
		case MapInstanceType::Battleground:
			return "Battleground";
		case MapInstanceType::Arena:
			return "Arena";
		}
		return "Unknown";
	}
	...
	MapInstanceType MapInstanceTypeFromString(const std::string& str)
	{
		...
		if (str == "dungeon")
			return MapInstanceType::Dungeon;
		if (str == "raid")
			return MapInstanceType::Raid;
		if (str == "battleground")
			return MapInstanceType::Battleground;
		if (str == "arena")
			return MapInstanceType::Arena;
		return MapInstanceType::OpenWorld;
	}
	...
	bool MapRegistry::Load(const std::string& path)
	{
		...
		while (true)
		{
			...
			if (arrayEnd != std::string::npos && entryStart > arrayEnd)
				break;
