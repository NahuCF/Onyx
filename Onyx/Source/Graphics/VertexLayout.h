...
namespace Onyx {
	...
	public:
		...
		void PushFloat(uint32_t count, bool normalized = false)
		{
			...
			{
			case 1:
				Push(VertexAttributeType::Float, normalized);
				break;
			case 2:
				Push(VertexAttributeType::Float2, normalized);
				break;
			case 3:
				Push(VertexAttributeType::Float3, normalized);
				break;
			case 4:
				Push(VertexAttributeType::Float4, normalized);
				break;
			}
		}
		...
		void PushInt(uint32_t count)
		{
			...
			{
			case 1:
				Push(VertexAttributeType::Int);
				break;
			case 2:
				Push(VertexAttributeType::Int2);
				break;
			case 3:
				Push(VertexAttributeType::Int3);
				break;
			case 4:
				Push(VertexAttributeType::Int4);
				break;
			}
		}
